...
namespace CSOS.Shell.Core
{
    public static unsafe class GUITerminal
    {
        ...
        public static void Init(Graphics newGraphics, uint backgroundcolour)
        {
            ...
            for (; ; )
            {
                ...
                else if (code == KeyCode.Delete)
                {
                    if (Line.Length != 0)
                    {
                        ...
                        if (X != 0) SetCursorPosition(X - fontWidth, Y); else SetCursorPosition(Program.ScreenWidth - fontWidth * 3, Y - fontHeight);
                        graphics.Update();
                    }
                }
                else if (code != 0)
                {
                    ...
                    SetCursorPosition(X - fontWidth, Y);
                }
            }
