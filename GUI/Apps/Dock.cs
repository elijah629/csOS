    ...
    internal class Dock : App
    {
        ...
        public override void InputUpdate()
        {
            ...
            for (int i = 0; i < Core.System.OpenApps.Count; i++)
            {
                ...
                if (PS2Mouse.X > Core.System.OpenApps[i].X_Dock && PS2Mouse.X < Core.System.OpenApps[i].X_Dock + ApplicationIconSize && PS2Mouse.Y > Y + Devide && PS2Mouse.Y < Y + Devide + ApplicationIconSize)
                {
                    ...
                    {
                        Core.System.OpenApps[i].Visible = !Core.System.OpenApps[i].Visible;
        ...
        public override void UIUpdate()
        {
            ...
            for (int i = 0; i < Core.System.OpenApps.Count; i++)
            {
                ...
                if (Core.System.OpenApps[i].Actived && Core.System.OpenApps[i].Visible) Program.graphics.DrawFilledCircle(0x23afa1, aX + (ApplicationIconSize / 2), Y + Devide + ApplicationIconSize + (Devide / 4), 2);
